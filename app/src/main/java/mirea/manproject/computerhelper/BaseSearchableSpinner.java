...
public class BaseSearchableSpinner extends androidx.appcompat.widget.AppCompatSpinner implements View.OnTouchListener,
        BaseSearchableListDialog.SearchableItem {

    public static final int NO_ITEM_SELECTED = -1;
    private Context _context;
    private List _items;
    private BaseSearchableListDialog _searchableListDialog;
    ...
    private void init() {
        ...
        _searchableListDialog = BaseSearchableListDialog.newInstance
                (_items);
    ...
    public void setOnSearchTextChangedListener(BaseSearchableListDialog.OnSearchTextChanged onSearchTextChanged) {
