...
public class BaseSearchableListDialog extends DialogFragment implements
    ...
    public BaseSearchableListDialog() {

    }

    public static BaseSearchableListDialog newInstance(List items) {
        BaseSearchableListDialog multiSelectExpandableFragment = new
                BaseSearchableListDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        rootView.setBackgroundColor(getResources().getColor(R.color.spinnerBack));
        setData(rootView);
